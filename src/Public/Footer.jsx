                ...
                <div className='customerService'>
                    ...
                    <div className='customerServiceList'>
                        <ul className='animals'>
                            <li><Link to='/account/order'>Track Order</Link></li>
                ...
                <div className='siteMap'>
                    ...
                    <div className='siteMapCat'>
                        <ul className='catList'>
                            ...
                            <li><Link to='/cat/toys'>Cat Toys</Link></li>
                            <li><Link to='/cat/beds'>Cat Beds</Link></li>                        
                        </ul>
                    </div>
                    <div className='siteMapDog'>
                        <ul className='dogList'>
                            ...
                            <li><Link to='/dog/toys'>Dog Toys</Link></li>
                            <li><Link to='/dog/beds'>Dog Beds</Link></li>                        
                        </ul>
                    </div>
                </div>

                <div className='cute'>
                    <img src='https://img.icons8.com/cotton/64/000000/cat--v3.png' alt='' />
                </div>
